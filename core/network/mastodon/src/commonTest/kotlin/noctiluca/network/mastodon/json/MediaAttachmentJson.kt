package noctiluca.network.mastodon.json

val JSON_IMAGE_3_4_10 = """
{
  "id": "22345792",
  "type": "image",
...
val JSON_IMAGE = JSON_IMAGE_3_4_10.removeTextUrl()
val JSON_VIDEO = JSON_VIDEO_3_4_10.removeTextUrl()
val JSON_GIFV = JSON_GIFV_3_4_10.removeTextUrl()
val JSON_AUDIO = JSON_AUDIO_3_4_10.removeTextUrl()

private fun String.removeTextUrl() = replace(
    """"text_url":".+?",""".toRegex(),
    "",
)
